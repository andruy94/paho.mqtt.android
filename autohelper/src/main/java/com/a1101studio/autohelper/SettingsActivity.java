...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || GeneralPreferenceFragment2.class.getName().equals(fragmentName)
    ...
    public static class GeneralPreferenceFragment2 extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_warn);
            setHasOptionsMenu(true);
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(getActivity().getString(R.string.warn_key_sub_kanal)));
            bindPreferenceSummaryToValue(findPreference(getActivity().getString(R.string.warn_key_web_adress)));
            bindPreferenceSummaryToValue(findPreference(getActivity().getString(R.string.warn_key_write_kanal)));
        }
